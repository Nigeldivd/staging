<svelte:head>
    <title>Login - DIVD.works</title>
</svelte:head>

<section class="h-full bg-black">
    <article
        class="h-full bg-black text-[#FFD736] dark:bg-black dark:text-[#FFD736]"
    >
        <div
        ...
        >
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
                <div
                    class="bg-black px-6 py-12 shadow-sm sm:rounded-lg sm:px-12"
                >
                    <form class="space-y-6" action="#" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex gap-3">
                                ...
                                <label
                                    for="remember-me"
                                    class="block text-sm/6 text-white"
                                    >Remember me</label
                                >
                            </div>
