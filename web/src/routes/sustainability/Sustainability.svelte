<script lang="ts">
    ...
    import SustainabilityPicture from "../../assets/stock/sustainability.jpg";
...
<svelte:head>
    <title>Sustainability - DIVD.works</title>
    <meta
        name="description"
